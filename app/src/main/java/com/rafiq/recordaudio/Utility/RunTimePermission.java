package com.rafiq.recordaudio.Utility;
...
public class RunTimePermission {
     ...
     * @return permissions status
     */
    public static boolean checkPermissionWithDialog(AppCompatActivity activity, String[] permissions){
     ...
     * @return permissions status
     */
    public static boolean checkRequiredPermissions(AppCompatActivity activity){
        String[] permissions = {
